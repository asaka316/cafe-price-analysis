...
# data/tullys-products.csv を読み込む
...
csv_path = os.path.join(data_dir, 'tullys-products.csv')
...
for category, group in df.groupby('category'):
    ...
    plt.savefig(os.path.join(image_dir, f'{safe_category}_bar.png'))
    plt.close()